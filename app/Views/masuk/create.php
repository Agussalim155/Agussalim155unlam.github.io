...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Form Tambah Data Pemasukan</h2>
            <form action="/masuk/save" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="form-group row">
                    <label for="angka" class="col-sm-2 col-form-label">Angka</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('angka')) ? 'is-invalid' : ''; ?>" id="angka" name="angka" autofocus value="<?= old('angka'); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pemasukan" name="pemasukan" value="<?= old('pemasukan'); ?>">
                    </div>
                </div>
                <div class="form-group row">
